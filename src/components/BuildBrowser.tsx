    ...
    if (props.gameType === "helldivers2") {
      return {
        ...
        secondaryOptions: [
          ...
          { value: "destroy-hive-lords", label: "Destroy Hive Lords" },
          ...
          { value: "disable-bot-factories", label: "Disable Bot Factories" },
          { value: "eliminate-devastators", label: "Eliminate Devastators" },
          { value: "sabotage-supply-lines", label: "Sabotage Supply Lines" },
          { value: "extract-strategic-assets", label: "Extract Strategic Assets" },
          { value: "emergency-evacuation", label: "Emergency Evacuation" },
